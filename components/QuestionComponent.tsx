...
export const QuestionComponent: React.FC<QuestionProps> = ({ question }) => {
  ...
  const postAnswer = () => {
    axiosJWT
      .post(
        `https://rabr.herokuapp.com/api/question/answer/${question.id}`,
        { answer },
  ...
  const likeAnswerHandler = (id: string) => {
    axiosJWT
      .put(
        `https://rabr.herokuapp.com/api/question/like-answer/${question.id}`,
        { answerId: id },
        { withCredentials: true }
      )
      .then(() => {
  ...
  const deleteAnswer = (id: string) => {
    axiosJWT
      .put(
        `https://rabr.herokuapp.com/api/question/delete-answer/${question.id}`,
        { answerId: id },
        { withCredentials: true }
      )
      .then(() => {
